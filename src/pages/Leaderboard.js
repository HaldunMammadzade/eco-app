            ...
            <Box height={"100%"}>
                  <Box >
                        ...
                        <Box position={"absolute"} top="6rem" display={"flex"} justifyContent={"space-around"} w={"100%"}>
                              <Box>
                                    <Image border={"4px solid #0E7F3D"} mt={"50px"} w={"120px"} h={"120px"} borderRadius={"50%"} src={person} />
                              ...
                              <Box position={"relative"}>
                                    <Image border={"4px solid #FFD912"} w={"120px"} h={"120px"} borderRadius={"50%"} src={person} />
                  ...
                  <Box className="animated fadeInRight" h={"70px"} mb={"20px"} display={"flex"} alignItems={"center"} justifyContent={"space-between"} bgColor={"#CECACA"} borderRadius={"20px"} mx={"20px"} mt={"20px"} px={"20px"} py={"5px"} fontSize={"18px"}>
                        <Box display={"flex"} alignItems={"center"}>
                              ...
                              <Image mr={"10px"} w={"50px"} h={"50px"} borderRadius={"50%"} src={person} />
                              <Text color={"black"} mr={"10px"} fontSize={'14px'} mb={"0"}>Tahir Tahirov</Text>
                        </Box>
                        <Box display={"flex"} alignItems={"center"}>
